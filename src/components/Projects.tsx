        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project, index) => (
            <motion.div
              ...
              className="group rounded-2xl border border-foreground/10 bg-background overflow-hidden hover:border-blue-500/50 hover:shadow-xl transition-all duration-300 flex flex-col h-full cursor-pointer"
              ...
              <div className="p-6 flex flex-col h-full">
                <div className="flex justify-between items-start mb-4">
                  ...
                  <div className="flex gap-3">
                    <a
                      href={project.github}
                      className="text-foreground/60 hover:text-blue-600 dark:hover:text-blue-400 transition-colors relative z-10"
                      target="_blank"
